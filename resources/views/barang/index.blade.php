        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="#" class="btn btn-sm btn-info"><i class="fas fa-qrcode" style="color: white"></i>&nbsp;&nbsp;QR Code</a>
                    <a href="#" class="btn btn-sm btn-dark"><i class="fas fa-barcode" style="color: white"></i>&nbsp;&nbsp;Barcode</a>
                </td>
                <td class="text-center">
